...
- проведен анализ типов данных в проекте;
- выбраны подходящие типы для идентификаторов;
- изменены типы некоторых полей;
- в таблицу `products` добавлено поле `JSON`;
- показаны примеры хранения данных в `JSON`;
- приведены SQL-примеры вставки и выборки данных из `JSON`.
